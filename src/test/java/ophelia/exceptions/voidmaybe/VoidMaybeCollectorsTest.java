...
import static ophelia.exceptions.voidmaybe.VoidMaybeCollectors.toUniqueSuccess;
...
public class VoidMaybeCollectorsTest {
	...
	public void empty_set_should_not_be_unique() throws Exception {
		VoidMaybe unique = Stream.<VoidMaybe>empty().collect(toUniqueSuccess());
	...
	public void single_failure_should_not_be_unique() throws Exception {
		...
		VoidMaybe unique = Stream.of(failure).collect(toUniqueSuccess());
	...
	public void multiple_failures_should_not_be_unique() throws Exception {
		...
		VoidMaybe unique = Stream.of(failure, failure2).collect(toUniqueSuccess());
	...
	public void multiple_successes_should_be_unique() throws Exception {
		...
		VoidMaybe unique = Stream.of(success, success2).collect(toUniqueSuccess());
	...
	public void unique_success_should_be_unique() throws Exception {
		...
		VoidMaybe unique = Stream.of(success).collect(toUniqueSuccess());
	...
	public void unique_success_with_some_failures_should_be_unique() throws Exception {
		...
		VoidMaybe unique = Stream.of(success, failure, failure2).collect(toUniqueSuccess());
